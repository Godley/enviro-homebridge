...
import { Reading, Grow, Board } from './enviro';
 ...
 */
export class EnviroGrow implements Board {
  name: string;
  mac?: string;
  humid: Service;
  temp: Service;
  ...
  constructor(
    ...
    this.accessory.getService(this.platform.Service.AccessoryInformation)!
      ...
      .setCharacteristic(this.platform.Characteristic.Model, 'grow')
